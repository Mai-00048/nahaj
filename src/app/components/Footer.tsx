...
export default function Footer() {
  return (
    <footer className="relative bg-[#f5f5f5] text-[#0C1A71] px-8 py-16 font-sans overflow-hidden">

      {/* ✅ خلفية SVG ديكورية شفافة */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start gap-12">
        ...
        <div className="flex-1">
          <Image src="https://img.freepik.com/premium-vector/vision-vector-logo-vintage-template-illustration-design_1094201-139.jpg" alt="Your Logo" width={150} height={40} />
         ...
         {/* 🌐 أيقونات التواصل الاجتماعي بدون روابط */}
    ...
    <div key={item.label} className="flex items-center space-x-2">
      ...
      <Link
        ...
        className={`text-lg hover:underline ${
          item.active ? "text-[#0C1A71]" : "text-[#0C1A71]/80"
        }`}
      >
        {item.label}
      </Link>
      ...
      {/* 📄 الشريط السفلي لحقوق النشر والروابط القانونية */}
